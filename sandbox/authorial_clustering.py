...
def problem_set_run(problem_set_id: int,
    ...
    try:
        ...
        hac_average_pred, hac_average_evals = clu_lss.eval_cluster_hac(
                linkage="average")
        hdp_pred, hdp_evals = clu_lss.eval_cluster_hdp()
        true_pred, true_evals = clu_lss.eval_true_clustering()
...
# =============================================================================
        ...
        return (Tools.form_problemset_result_dictionary(
                dictionaries=[
                        # Non normalised:
                        dbscan_evals, hdbscan_evals, ms_evals, xm_evals,
                        hac_complete_evals, hac_single_evals,
                        hac_average_evals, hdp_evals, true_evals,
                        # Normalised:
                ...
                l2_norms=[False, False, False, False,
